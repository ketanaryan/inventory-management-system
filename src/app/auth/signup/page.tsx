    ...
    <div className="flex items-center justify-center min-h-screen bg-background text-foreground font-sans selection:bg-primary/30 relative">
      ...
      <div className="glass-panel p-10 rounded-3xl shadow-2xl border border-border relative z-10 w-full max-w-md mx-4 animate-fade-in overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8 relative z-10">
          ...
          <p className="text-sm text-muted-foreground mt-2">Initialize your presence on the network</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 relative z-10">
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                defaultValue=""
              >
                <option value="" disabled className="text-muted-foreground">Select Operating Class</option>
                <option value="manufacturer">Manufacturer Node</option>
                <option value="hospital">Hospital Terminal</option>
                <option value="consumer">Consumer Client</option>
              </select>
            ...
            {errors.role && <span className="text-red-400 text-xs mt-2 block font-medium">Network Designation is required</span>}
          </div>
          ...
          <button
            ...
            type="submit"
          >
            <span className="relative z-10">Initialize Registration Sequence</span>
            <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
          </button>
          
          <div className="text-center mt-6">
            <span className="text-sm text-muted-foreground">Already an active node? </span>
